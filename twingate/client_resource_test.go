...
func TestResourceCreateCheckErrors(t *testing.T) {
	t.Run("Test Twingate Resource : Resource Create Check Errors", func(t *testing.T) {
		r := createResourceResponse{}
		responseErrors := r.checkErrors()

		assert.Nil(t, responseErrors)
	})
}
...
func TestClientReadResourcesResponseError(t *testing.T) {
	t.Run("Test Twingate Resource : Client Read Resources Response Error", func(t *testing.T) {
...
func TestResourceReadCheckErrorsPositive(t *testing.T) {
	t.Run("Test Twingate Resource : Resource Read Check Errors Positive", func(t *testing.T) {
...
func TestResourceReadCheckErrorsNegative(t *testing.T) {
	t.Run("Test Twingate Resource : Resource Read Check Errors Positive", func(t *testing.T) {
		f := []*queryResponseErrors{}
		errors := []*queryResponseErrors{}
		r := readResourceResponse{}
		r.Errors = errors
		responseErrors := r.checkErrors()

		assert.NotNil(t, responseErrors)
		assert.Equal(t, f, responseErrors)
	})
}
...
func TestResourceUpdateCheckErrors(t *testing.T) {
	t.Run("Test Twingate Resource : Resource Update Check Errors", func(t *testing.T) {
...
func TestResourceDeleteCheckErrors(t *testing.T) {
	t.Run("Test Twingate Resource : Resource Delete Check Errors", func(t *testing.T) {
