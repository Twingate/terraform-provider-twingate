...
import (
	...
	twingateDatasource "github.com/Twingate/terraform-provider-twingate/v5/twingate/internal/provider/datasource"
	"github.com/Twingate/terraform-provider-twingate/v5/twingate/internal/provider/providerdata"
	twingateResource "github.com/Twingate/terraform-provider-twingate/v5/twingate/internal/provider/resource"
...
func (t Twingate) Configure(ctx context.Context, request provider.ConfigureRequest, response *provider.ConfigureResponse) {
	...
	regionalURL := client.ResolveRegionalURL(ctx, network, url, time.Duration(httpTimeout)*time.Second, httpMaxRetry, apiToken, t.agent, t.version)
