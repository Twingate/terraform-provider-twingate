...
- `tags` (Map of String) Consists of a key-value pairs that correspond with tags to be set on the resource.
...
- `tags_all` (Map of String) Consists of a key-value pairs that correspond with tags to be set on the resource merged with default tags from provider configuration.
