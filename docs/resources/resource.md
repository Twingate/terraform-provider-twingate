...
- `is_browser_shortcut_enabled` (Boolean) Indicates whether this Resource will display a browser shortcut in the client.
- `is_visible` (Boolean) Indicates if the Resource is active.
