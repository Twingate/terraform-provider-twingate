...
- `group_ids` (Set of String) List of Group IDs that have permission to access the Resource. These IDs can be retrieved from the twingate_group and twingate_groups data sources, or directly from the Twingate API
